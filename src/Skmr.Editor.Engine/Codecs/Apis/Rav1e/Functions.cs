...
namespace Skmr.Editor.Engine.Codecs.Apis.Rav1e
{
    public static class Functions
    {
        ...
        /// </returns>
        [DllImport(DllPath)]
        public static extern int rav1e_config_set_rc_summary(IntPtr cfg, IntPtr data, ulong size_t);

        /// <summary>
        /// Request to emit pass data
        /// </summary>
        [DllImport(DllPath)]
        public static extern void rav1e_config_set_emit_data(IntPtr cfg, int data);
        ...
        [DllImport(DllPath)]
        public static extern int rav1e_config_set_pixel_format(IntPtr cfg, byte bit_depth);


        [DllImport(DllPath)]
        public static extern int rav1e_config_set_color_description(IntPtr cfg, int data);


        [DllImport(DllPath)]
        public static extern int rav1e_config_set_content_light(IntPtr cfg, short max_content_light_level, short max_frame_average_light_level);


        [DllImport(DllPath)]
        public static extern int rav1e_config_set_mastering_display(IntPtr cfg, IntPtr primaries, string white_point, uint max_luminance, uint min_luminance);
        ...
        /// <returns></returns>
        [DllImport(DllPath)]
        public static extern int rav1e_config_parse(IntPtr cfg, [MarshalAs(UnmanagedType.LPStr)] string key, [MarshalAs(UnmanagedType.LPStr)] string value);


        [DllImport(DllPath)]
        public static extern int rav1e_config_parse_int(IntPtr cfg, [MarshalAs(UnmanagedType.LPStr)] string key, int value);
        #endregion
        ...
        [DllImport(DllPath)]
        public static extern int rav1e_frame_set_type(IntPtr ctx);


        [DllImport(DllPath)]
        public static extern int rav1e_frame_set_opaque(IntPtr ctx);


        [DllImport(DllPath)]
        public static extern int rav1e_frame_add_t35_metadata(IntPtr frame, byte country_code, byte country_code_extension_byte, IntPtr data, IntPtr size_t);
        #endregion
        ...
        [DllImport(DllPath)]
        public static extern int rav1e_rc_summary_size(IntPtr ctx);
        ...
        [DllImport(DllPath)]
        public static extern int rav1e_rc_second_pass_data_required(IntPtr ctx);


        [DllImport(DllPath)]
        public static extern int rav1e_rc_send_pass_data(IntPtr ctx);


        [DllImport(DllPath)]
        public static extern int rav1e_twopass_bytes_needed(IntPtr ctx);
        ...
        /// <returns></returns>
        [DllImport(DllPath)]
        public static extern int rav1e_twopass_in(IntPtr ctx, IntPtr buf, IntPtr buf_size);
        ...
        [DllImport(DllPath)]
        public static extern int rav1e_frame_extract_plane();
